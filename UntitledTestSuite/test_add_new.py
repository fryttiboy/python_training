...
class TestAddNew(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        self.create_new_contacts(wd, firstname= "wrtertfe", middlename= "swdwdef", lastname= "efwafrar", nickname= "rfarfwefa", title= "gbfshsrt", company= "rragsrehgrt",
    ...
    def test_add_null_new(self):
        ...
        self.login(wd, username= "admin", password= "secret")
        self.open_add_new(wd)
        self.create_new_contacts(wd, firstname= "", middlename= "", lastname= "", nickname= "", title= "", company= "",
    ...
    def create_new_contacts(self, wd, firstname, middlename, lastname, nickname, title, company, address, home, mobile,
